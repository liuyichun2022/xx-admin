...
import com.xx.p.modules.admin.module.mapper.UmsAdminLoginLogMapper;
import com.xx.p.modules.admin.module.mapper.UmsAdminMapper;
...
import com.xx.p.modules.admin.service.UmsAdminRoleRelationService;
...
public class UmsAdminServiceImpl extends ServiceImpl<UmsAdminMapper, UmsAdmin> implements UmsAdminService {
    ...
    @Override
    public UmsAdmin register(UmsAdminParamDTO umsAdminParam) {
    ...
    private void insertLoginLog(String username) {
        ...
        loginLog.setCreateTime(LocalDateTimeUtil.now());
    ...
    private void updateLoginTimeByUsername(String username) {
        ...
        record.setLoginTime(LocalDateTimeUtil.now());
        QueryWrapper<UmsAdmin> wrapper = new QueryWrapper<>();
        wrapper.lambda().eq(UmsAdmin::getUsername,username);
